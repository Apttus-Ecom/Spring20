...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">Apttus Digital Commerce Spring &#x27;20</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter modules">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/CmsConfigurationSummaryModule.html" data-type="entity-link">CmsConfigurationSummaryModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-CmsConfigurationSummaryModule-a37fc9c0a905af8599048c619de79037"' : 'data-target="#xs-components-links-module-CmsConfigurationSummaryModule-a37fc9c0a905af8599048c619de79037"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-CmsConfigurationSummaryModule-a37fc9c0a905af8599048c619de79037"' :
                                            'id="xs-components-links-module-CmsConfigurationSummaryModule-a37fc9c0a905af8599048c619de79037"' }>
                                            <li class="link">
                                                <a href="components/ConfigurationSummaryComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ConfigurationSummaryComponent</a>
                                            </li>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/ConfigurationModule.html" data-type="entity-link">ConfigurationModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-ConfigurationModule-ded890a4f0421b555ee35001ed49c909"' : 'data-target="#xs-components-links-module-ConfigurationModule-ded890a4f0421b555ee35001ed49c909"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-ConfigurationModule-ded890a4f0421b555ee35001ed49c909"' :
                                            'id="xs-components-links-module-ConfigurationModule-ded890a4f0421b555ee35001ed49c909"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/ConstraintRuleModule.html" data-type="entity-link">ConstraintRuleModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-ConstraintRuleModule-a8619c0c82c949306165044fc55fa7d5"' : 'data-target="#xs-components-links-module-ConstraintRuleModule-a8619c0c82c949306165044fc55fa7d5"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-ConstraintRuleModule-a8619c0c82c949306165044fc55fa7d5"' :
                                            'id="xs-components-links-module-ConstraintRuleModule-a8619c0c82c949306165044fc55fa7d5"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/TableModule.html" data-type="entity-link">TableModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-TableModule-3b58b9ac632a337079b5bd58d6c8ea62"' : 'data-target="#xs-components-links-module-TableModule-3b58b9ac632a337079b5bd58d6c8ea62"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-TableModule-3b58b9ac632a337079b5bd58d6c8ea62"' :
                                            'id="xs-components-links-module-TableModule-3b58b9ac632a337079b5bd58d6c8ea62"' }>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/CmsConstraintsMappingService.html" data-type="entity-link">CmsConstraintsMappingService</a>
                            </li>
                            <li class="link">
                                <a href="classes/ConfigurationMappingService.html" data-type="entity-link">ConfigurationMappingService</a>
                            </li>
                            <li class="link">
